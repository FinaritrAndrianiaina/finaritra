...
<Atropos shadowScale={0} class="overflow-hidden ">
	<div class="container mx-auto flex flex-col justify-center space-y-2 transition-transform" style="min-height: 80vh; ">
		<div
	...
	<section class="px-56">
		...
		<div class="flex flex-wrap">
			<p class="w-2/3 text-center">
				...
				>. <br />
				En ce moment, je suis étudiant en alternance en tant qu'Ingénieur d'étude et de développement
				chez Pulse. Je suis passionné par la création de solutions innovantes et j'aime travailler sur
				des projets stimulants qui ont un impact réel sur les utilisateurs. Je suis toujours à la recherche
				de nouvelles connaissances et opportunités.
			</p>
		</div>
	</section>
	<section class="px-56 flex flex-col">
